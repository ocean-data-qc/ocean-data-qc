...
const tab_project = require('tab_project');
...
module.exports = {
        ...
        tools.load_modal(url, () => {
            ...
            $('.add_new_tab').on('click', function() {
                ...
                new_fieldset.find('.add_new_plot').click(function() {
                    var new_row = tab_project.get_new_row(self.file_columns);
                ...
                tab_project.load_delete_tab_buttons();
            });
    ...
    load_layout: function(type='custom') {
        ...
        tab_project.create_qc_tab_tables(qc_plot_tabs_final, self.file_columns);
        tab_project.load_delete_tab_buttons();
    },
